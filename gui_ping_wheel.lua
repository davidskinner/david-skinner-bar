...
local pingCommands = {                             -- the options in the ping wheel, displayed clockwise from 12 o'clock
    { name = "Attack",  color = { 1, 1, 1, 1 } }, -- color is optional, if no color is chosen it will be white
    { name = "Rally",   color = { 0.4, 0.8, 0.4, 1 } },
    { name = "Defend",  color = { 0.7, 0.9, 1, 1 } },
    { name = "Retreat", color = { 0.9, 0.7, 1, 1 } },
    { name = "Stop",    color = { 1, 0.2, 0.2, 1 } },
    { name = "rez/con gamer",    color = { 0.7, 0.6, 0.3, 1 } },
}

local pingMessages = {
    -- let's give these commands rainbow colors!
    { name = "💪OP💪",      color = { 1, 1, 1, 1 } },
    { name = "☭☭☭",      color = { 1, 0, 0, 1 } },
    { name = "Sluuuuuuurp", color = { 1, 1, 1, 1 } },
    { name = "💯Caned💯",  color = { 1, 1, 0, 1 } },
    { name = "big🧠",      color = { 1, 1, 1, 1 } },
    { name = "🍕🍕EAT🍕🍕",  color = { 1, 1, 1, 1 } },
    { name = "↗↗↗GET BIG↗↗↗",       color = { 0, 1, 0, 1 } },
    { name = "Coming",      color = { 1, 1, 1, 1 }, misspellings = {
        "Comign", "Cmoing", "Cominng", "Comnig",
         "Comng", "Conming", "Commimg",
    } },
    { name = "Mogged", color = { 1, 1, 1, 1 } },
    { name = "👁️👄👁️ ", color = { 1, 1, 1, 1 } },
    { name = "👀",   color = { 1, 1, 1, 1 } },
    { name = "💩", color = { 0.72, 0.45, 0.2, 1 } },
}
...
function widget:MousePress(mx, my, button)
    if keyDown or button == 4 or button == 5 then
        ...
        elseif button == 3 or button == 5 then
            -- randomize misspellings each time the messages wheel opens
            for _, entry in ipairs(pingMessages) do
                if entry.misspellings then
                    entry.name = entry.misspellings[math.random(#entry.misspellings)]
                end
            end
